---
title: grafana通过telegraf数据源监控linux主机的指标
author: starifly
date: 2020-05-18T22:04:09+08:00
lastmod: 2020-05-18T22:04:09+08:00
categories: [grafana]
tags: [grafana,telegraf,linux]
draft: true
slug: grafana-monitors-linux-metrics-via-telegraf-data-source
---

## telegraf配置

```
[root@bogon telegraf]# cat /etc/telegraf/telegraf.d/host-stats.conf
[[inputs.net]]
...
```
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "thresholds": "50,80",
      "title": "Disk_used_percent(max point)",
      "type": "singlestat",
      "valueFontSize": "100%",
      "valueMaps": [
        {
    ...
    },
    {
      ...
      "targets": [
        ...
        },
        {
          ...
          "orderByTime": "ASC",
          "policy": "default",
          "query": "SELECT mean(\"used_percent\") AS \"used_percent\" FROM \"disk\" WHERE $timeFilter GROUP BY time($interval), \"path\" fill(null)",
          "rawQuery": true,
          "refId": "G",
          "resultFormat": "time_series",
          "select": [
    ...
    },
    {
      ...
      "targets": [
        ...
        },
        {
          ...
          "orderByTime": "ASC",
          "policy": "default",
          "query": "SELECT non_negative_derivative(mean(\"bytes_sent\"), 10s)*8 AS \"OUT\" FROM \"net\" WHERE $timeFilter AND \"interface\" = 'ens192' GROUP BY time($interval) fill(null)",
          "rawQuery": true,
          "refId": "A",
          "resultFormat": "time_series",
          "select": [
  ...
  "timezone": "browser",
  "title": "Telegraf Host Metrics Copy",
  "uid": "Bb02c96Wk",
  "variables": {
    "list": []
  },
